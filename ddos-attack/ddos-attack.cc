 ...
 * (https://github.com/Saket-Upadhyay/ns3-cybersecurity-simulations/blob/master/LICENSE)
 ...
 *             (B0),(B2)...(Bn)
 *
 *  N0 is legitimate user, communicating with server N2 (data server) via node
 * N1 (maybe website server interface ) B0-Bn are bots DDoS-ing the network.
 *
...
int main(int argc, char *argv[]) {
  ...
  AnimationInterface anim("DDoSim1Bot.xml");
